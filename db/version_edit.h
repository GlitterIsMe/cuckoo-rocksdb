...
struct FileMetaData {
  ...
  FileMetaData(uint64_t file, uint32_t file_path_id, uint64_t file_size,
               ...
               const std::string& _file_checksum_func_name, uint64_t group_filter_block_num = 0)
...
class VersionEdit {
 public:
  ...
  void AddFile(int level, uint64_t file, uint32_t file_path_id,
               ...
               const std::string& file_checksum_func_name, uint64_t group_filter_block_num = 0) {
    ...
    new_files_.emplace_back(
        level, FileMetaData(file, file_path_id, file_size, smallest, largest,
                            ...
                            file_checksum, file_checksum_func_name, group_filter_block_num));
  }
